# API_Contracts.md — gaia/monad-clarity
...
## Services\Request — `Gaia\Clarity\Services\Request`
...
## Services\Response — `Gaia\Clarity\Services\Response`
...
## Services\Route — `Gaia\Clarity\Services\Route`
...
## Services\View — `Gaia\Clarity\Services\View`
...
## Services\Session — `Gaia\Clarity\Services\Session`
...
## Services\Mediator — `Gaia\Clarity\Services\Mediator`
...
## Services\Files — `Gaia\Clarity\Services\Files`
...
## Services\Schema — `Gaia\Clarity\Services\Schema`
...
## Services\Migration — `Gaia\Clarity\Services\Migration`
...
## Services\Cache — `Gaia\Clarity\Services\Cache` (PSR-16)
...
## Services\Event — `Gaia\Clarity\Services\Event`
...
## Services\HttpClient — `Gaia\Clarity\Services\HttpClient` (PSR-18)
...
## Services\LLM — `Gaia\Clarity\Services\LLM`
...
Adapters: `Gaia\Clarity\Services\LLMAdapters\{OpenAI,Anthropic,DeepSeek,Gemini}`, each
...
## Middlewares\Csrf — `Gaia\Clarity\Middlewares\Csrf`
...
## Middlewares\Logger — `Gaia\Clarity\Middlewares\Logger` (PSR-3)
...
## Middlewares\Authentication — `Gaia\Clarity\Middlewares\Authentication`
...
## Middlewares\RBAC — `Gaia\Clarity\Middlewares\RBAC`

user→role→permission, user→direct-permission, role→permission checks; route guards;
service-level checks.

## Middlewares\RateLimiter — `Gaia\Clarity\Middlewares\RateLimiter`
...
## Middlewares\CORS — `Gaia\Clarity\Middlewares\CORS`
...
## Middlewares\Jsonify — `Gaia\Clarity\Middlewares\Jsonify`
...
## Middlewares\MetaTag — `Gaia\Clarity\Middlewares\MetaTag`
...
## Services\Console — `Gaia\Clarity\Services\Console`
